...
// const critical = require('critical'); // check if i need that
...
gulp.task('build:sprite', function () {
  var spriteData = gulp.src('src/img/sprite/*.png')
    ...
    .pipe(plugins.spritesmith({
      ...
      imgPath: 'http://res.cloudinary.com/ds3tq91lc/image/upload/v1513252667/sprite_vuowvb.png', // path to image that should know css // '../img/sprite.png'
      retinaImgPath: 'http://res.cloudinary.com/ds3tq91lc/image/upload/v1513252672/sprite_2x_f1bteb.png', // path to retina image that should know css // '../img/sprite@2x.png'
...
gulp.task('build:php', function () { // test
  return gulp.src(path.src.php)
    ...
    // .pipe(plugins.phplint()) // php lint deprecated 
    // .pipe(plugins.phplint.reporter('fail')) // php lint deprecated 
    .pipe(gulp.dest('dev/'))
});
// replace fonts 
...
gulp.task('build', [
  // 'build:html', // check if need rigger
  'build:style',
  'build:js',
  'build:vendor-js',
  'build:img',
